...
import demo.com.rounter.qr.camera.Size;
import demo.com.rounter.qr.decode.DecodeListener;
import demo.com.rounter.qr.decode.DecodeThread;
import demo.com.rounter.qr.decode.LuminanceSource;
import demo.com.rounter.qr.decode.PlanarYUVLuminanceSource;
import demo.com.rounter.qr.decode.RGBLuminanceSource;
import demo.com.rounter.qr.util.DocumentUtil;
import demo.com.rounter.qr.view.CaptureView;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, PreviewFrameShotListener, DecodeListener,
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (!mCameraManager.isCameraAvailable()) {
            Toast.makeText(CaptureActivity.this, "摄像头打开失败", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
