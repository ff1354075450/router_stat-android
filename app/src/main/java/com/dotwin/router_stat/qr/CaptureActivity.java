package com.dotwin.router_stat.qr;
...
import com.dotwin.router_stat.qr.camera.CameraManager;
import com.dotwin.router_stat.qr.camera.PreviewFrameShotListener;
import com.dotwin.router_stat.qr.camera.Size;
import com.dotwin.router_stat.qr.decode.DecodeListener;
import com.dotwin.router_stat.qr.decode.DecodeThread;
import com.dotwin.router_stat.qr.decode.LuminanceSource;
import com.dotwin.router_stat.qr.decode.PlanarYUVLuminanceSource;
import com.dotwin.router_stat.qr.decode.RGBLuminanceSource;
import com.dotwin.router_stat.qr.util.DocumentUtil;
import com.dotwin.router_stat.qr.view.CaptureView;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, PreviewFrameShotListener, DecodeListener,
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        if(!mCameraManager.initCamera(holder)){
            Toast.makeText(CaptureActivity.this, "无权限打开摄像头", Toast.LENGTH_SHORT).show();
            return;
        }
